# Deployment Guide — IT-Stack GRAYLOG
...
- DNS entry: graylog.it-stack.lab → lab-proxy1
...
```sql
CREATE USER graylog_user WITH PASSWORD 'CHANGE_ME';
CREATE DATABASE graylog_db OWNER graylog_user;
```
...
- Client ID: $Module
- Valid redirect URI: https://graylog.it-stack.lab/*
- Web origins: https://graylog.it-stack.lab
...
```bash
curl -I https://graylog.it-stack.lab/health
```
