# Lab 20-06 — Production Deployment

**Module:** 20 — Graylog centralized log management  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-20-06.sh  
**Compose File:** docker/docker-compose.production.yml

## Objective

Deploy graylog in production with HA, monitoring, backup, and DR.

## Prerequisites

- Labs 20-01 through 20-05 pass
