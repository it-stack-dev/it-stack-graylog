# Lab 20-05 — Advanced Integration

**Module:** 20 — Graylog centralized log management  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-20-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect graylog to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 20-01 through 20-04 pass
