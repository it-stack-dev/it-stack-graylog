# Makefile — IT-Stack GRAYLOG (Module 20)
...
build: ## Build Docker image
	docker build -t it-stack/graylog:latest .
...
test-lab-01: ## Lab 01 — Standalone
	@bash tests/labs/test-lab-20-01.sh

test-lab-02: ## Lab 02 — External Dependencies
	@bash tests/labs/test-lab-20-02.sh

test-lab-03: ## Lab 03 — Advanced Features
	@bash tests/labs/test-lab-20-03.sh

test-lab-04: ## Lab 04 — SSO Integration
	@bash tests/labs/test-lab-20-04.sh

test-lab-05: ## Lab 05 — Advanced Integration
	@bash tests/labs/test-lab-20-05.sh

test-lab-06: ## Lab 06 — Production Deployment
	@bash tests/labs/test-lab-20-06.sh

deploy: ## Deploy to target server (lab-proxy1)
	ansible-playbook -i ansible/inventory.yml ansible/playbooks/deploy-graylog.yml
